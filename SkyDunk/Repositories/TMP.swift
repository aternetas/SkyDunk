...
var tmpGames = [
    GameDTO(id: "NTAI-2KTA-RAKR", homeTeam: "ATL", guestTeam: "BOS", date: Date.now - 10, homeScore: 99, guestScore: 87, betIds: []),
    GameDTO(id: "TNOA-AKCC-CAOY", homeTeam: "DEN", guestTeam: "MIN", date: Date.now - 298, homeScore: 102, guestScore: 121, betIds: []),
    GameDTO(id: "AT20-RKOR-PYZ.", homeTeam: "UTA", guestTeam: "TOR", date: Date.now - 247922, homeScore: 110, guestScore: 102, betIds: []),
    GameDTO(id: "20!I-AKZO-R;AK", homeTeam: "LAL", guestTeam: "SAC", date: Date.now + 502433, homeScore: 0, guestScore: 0, betIds: []),
    GameDTO(id: "29ZK-RKXY-IR..", homeTeam: "LAC", guestTeam: "IND", date: Date.now + 5033, homeScore: 0, guestScore: 0, betIds: []),
